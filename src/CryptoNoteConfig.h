...
namespace parameters {
  ...
  const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xca983e7fc; // addresses start with "Jhaiara"
  ...
  const uint64_t MONEY_SUPPLY                                  = (uint64_t)(4200000000000); //-1
  ...
  const uint64_t COIN                                          = UINT64_C(4000000000000);     // pow(10, 6)
  const uint64_t MINIMUM_FEE                                   = UINT64_C(10000000);        // pow(10, 3)
...
const int      P2P_DEFAULT_PORT                              = 44745;
const int      RPC_DEFAULT_PORT                              = 44744;
